(() => {
  ...
  function createRow(country) {
    ...
    <td>
      <input type="text" class="form-control form-control-sm code3-input" value="${country.country_code3 || ""}" maxlength="3" />
    </td>
    <td>
      <input type="text" class="form-control form-control-sm name-input" value="${country.name || ""}" />
    </td>
    <td style="max-width:120px">
      <input type="number" class="form-control form-control-sm score-input" value="${Number(country.score) || 0}" step="1" />
    </td>
    <td class="text-end">
  ...
  function applyFilters(data) {
    ...
    if (q) {
      filtered = filtered.filter((c) => {
        return c.name.toLowerCase().includes(q) || (c.country_code2 || "").toLowerCase().includes(q) || (c.country_code3 || "").toLowerCase().includes(q);
      });
    }
    if (scoreFilter === "neg") {
...
//# sourceMappingURL=admin-countries.bundle.js.map
