(() => {
  ...
  // public/js/admin-salutations.js
  (function() {
    const PAGE_SIZE = 10;
    let currentPage = 1;
    let currentSearch = "";
    ...
    function renderTable() {
      tbody.innerHTML = "";
      if (!window.__salutationsPage || !Array.isArray(window.__salutationsPage.items) || window.__salutationsPage.items.length === 0) {
        const tr = document.createElement("tr");
    ...
    async function fetchPage() {
      ...
      try {
        ...
        console.error(e);
        tbody.innerHTML = '<tr><td colspan="3" class="text-danger">Error loading salutations.</td></tr>';
      } finally {
        hideLoading();
      }
    }
...
//# sourceMappingURL=admin-salutations.bundle.js.map
